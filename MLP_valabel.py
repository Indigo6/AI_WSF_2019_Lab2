...
def MLP_valabel(root_dir):
    ...
    for i in range(splits_num):     
        ...
        for j in range(length):
            ...
            y_temp.append(valabel_to_value(va_labels[j]))
        x.append(x_temp)
    ...
    write_score(cvscores,average_score,root_dir+'MLP/valabel_cvscores.txt')
